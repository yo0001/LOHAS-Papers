  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "法的情報",
        item: "https://lohas-papers.com/legal",
      },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-10">
          ...
          <table className="w-full text-sm border-collapse">
            <tbody>
              {[
                ...
                [
                  "連絡先",
                  "tatsuaki.lohas@gmail.com（お問い合わせはメールにてお願いいたします）",
                ],
        ...
        <section id="service" className="space-y-4 text-sm text-gray-600">
          ...
          <p>
            LOHAS Papers is an AI-powered academic paper search and multilingual
            summarization service operated by LOHAS Inc. The service
            cross-searches PubMed and Semantic Scholar databases, and provides
            AI-generated summaries and translations via Claude AI in 8 languages
            (Japanese, English, Korean, Chinese, Spanish, Portuguese, Thai,
            Vietnamese) at 3 difficulty levels (Expert, General, Kids).
          </p>
          <p>The service operates on a credit-based pay-as-you-go model:</p>
          ...
          <p>
            Credits can be purchased as one-time packs (Starter ¥600, Standard
            ¥2,200, Premium ¥5,500) or via monthly subscriptions (Pro ¥4,980/mo,
            Lab ¥29,800/mo, Institutional ¥98,000/mo). All prices include tax.
          </p>
        </section>
        ...
        <section id="terms" className="space-y-4 text-sm text-gray-600">
          ...
          <p>
            ...
            credentials. You must be at least 18 years old or have parental
            consent to create an account.
          </p>
          <h3 className="font-medium text-gray-800">2. Credits and Payment</h3>
          <p>
            Credits are consumed when you perform searches, view paper details,
            or request translations. Purchased credits do not expire. All
            payments are processed securely through Stripe. Prices are displayed
            in Japanese Yen (JPY) and include applicable taxes.
          </p>
          <h3 className="font-medium text-gray-800">3. Acceptable Use</h3>
          <p>
            You agree not to: abuse the Service or attempt to circumvent usage
            limits; use automated bots or scripts to access the Service;
          ...
          <p>
            Summaries and translations are generated by AI and may contain
            errors or inaccuracies. The Service is supervised by a licensed
            physician, but AI-generated content should not replace professional
          ...
          <p>
            Original academic papers are the property of their respective
            authors and publishers. AI-generated summaries are provided for
            personal informational use. The LOHAS Papers platform, branding, and
            technology are the property of LOHAS Inc.
          </p>
          <h3 className="font-medium text-gray-800">
        ...
        <section id="refund" className="space-y-4 text-sm text-gray-600">
          ...
          <p>
            Due to the digital nature of our service, credit purchases are
            generally non-refundable once credits have been delivered to your
            account. However, we will consider refund requests in the following
            circumstances:
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Service malfunction that prevented you from using purchased
              credits
            </li>
            <li>
              Duplicate or accidental purchases (reported within 24 hours)
            </li>
            <li>Credits were not properly applied to your account</li>
          </ul>
          <p>
            To request a refund, please contact us at tatsuaki.lohas@gmail.com
          ...
          <p>
            ...
            Upon cancellation, you will retain access to your subscription
            benefits until the end of your current billing period. No partial
            refunds are provided for the remaining days in a billing cycle.
            Unused credits from subscriptions do not carry over after
            cancellation.
          </p>
        </section>
        ...
        <section id="privacy" className="space-y-4 text-sm text-gray-600">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              ...
              and profile image obtained via Google OAuth sign-in
            </li>
            <li>
              <strong>Usage data:</strong> Search queries, service usage
              patterns, and credit transaction history
            </li>
            <li>
          ...
          <p>
            All payment processing is handled securely by Stripe, Inc. We do not
            store, collect, or have access to your credit card numbers or bank
            account details. Stripe&apos;s privacy policy governs the handling
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              With Anthropic (Claude AI) for generating summaries (search
              queries only, no personal data)
            </li>
          ...
          <p>
            ...
            encryption, secure authentication via OAuth 2.0, and rate limiting
            to protect your data. Our database is hosted on Supabase with
          ...
          <p>
            ...
            us at tatsuaki.lohas@gmail.com. We will process deletion requests
            within 30 days.
          </p>
          <h3 className="font-medium text-gray-800">Cookies</h3>
          <p>
            We use essential cookies for authentication and session management.
            We also use Vercel Analytics for anonymous, privacy-friendly website
        ...
        <section id="contact" className="space-y-4 text-sm text-gray-600">
          ...
          <p>
            If you have any questions about these policies, your account, or the
            Service, please contact us:
          </p>
          <ul className="list-none space-y-1">
            <li>
              <strong>Email:</strong> tatsuaki.lohas@gmail.com
            </li>
            <li>
              <strong>Company:</strong> LOHAS Inc. (LOHAS株式会社)
            </li>
            <li>
              <strong>Address:</strong> Luminaria Tower Ikebukuro 2104, 2-52-3
