...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "料金プラン",
      item: "https://lohas-papers.com/pricing",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-12">
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 capitalize">
                    {t(locale, `plan_${plan.key}`)}
                  </h3>
                  <p className="text-3xl font-bold text-gray-900 mt-2">
                    {formatPrice(plan.amount)}
                  </p>
                  <p className="text-sm text-gray-500">
                    {plan.credits} {t(locale, "creditsUnit")} (
                    {formatPrice(pricePerCredit(plan.amount, plan.credits))}/
                    {t(locale, "perCredit")})
                  </p>
                </div>
                <button
            ...
            {SUB_PLANS.map((plan) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {plan.credits} {t(locale, "creditsPerMonth")} (
                    {formatPrice(pricePerCredit(plan.amount, plan.credits))}/
                    {t(locale, "perCredit")})
                  </p>
                </div>
        ...
        <div className="text-center space-y-2 text-xs text-gray-400">
          <div className="flex items-center justify-center gap-3">
            ...
            <span>
              Secure payments powered by Stripe. PCI DSS compliant. All data
              encrypted via HTTPS.
            </span>
          </div>
