...
export const BYOK_MODELS: BYOKModel[] = [
  ...
  { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", provider: "anthropic", inputPrice: 3, outputPrice: 15, recommended: true },
  { id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5", provider: "anthropic", inputPrice: 3, outputPrice: 15 },
