...
const translations: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    maintenanceBanner: "現在AI検索機能を一時停止しております。ご不便をおかけし申し訳ございません。",
    ...
    // Topics
    topicsTitle: "人気トピック",
    topicsViewAll: "すべてのトピックを見る",
    topicsPageTitle: "研究トピック",
    topicsPageDesc: "AIが最新論文を要約した研究トピックを探索",
    topicSearchCta: "LOHAS Papersで検索する",
    topicRelated: "関連トピック",
    footerTopics: "トピック",
    // FAQ
    faqTitle: "よくある質問",
    ...
    faqQ6: "医師監修とは？",
    faqA6: "AI要約の品質と正確性を医師（上原吉敬）が監修しています。ただし、個別の医療アドバイスではありませんので、健康上の判断は必ず担当医にご相談ください。",
  },
  en: {
    appName: "LOHAS Papers",
    ...
    maintenanceBanner: "AI search is temporarily unavailable. We apologize for the inconvenience.",
    supervisedBadge: "Physician Supervised",
    supervisedName: "Yoshiaki Uehara, M.D.",
    supervisedAffiliation: "Physician",
    footerSupervised: "Supervised by Yoshiaki Uehara, M.D.",
    ...
    faqA6: "The quality and accuracy of AI summaries are supervised by Dr. Yoshiaki Uehara, M.D. However, this is not individual medical advice — always consult your doctor for health decisions.",
  },
  ko: {
    appName: "LOHAS Papers",
    ...
    maintenanceBanner: "현재 AI 검색 기능을 일시 중지하고 있습니다. 불편을 드려 죄송합니다.",
    ...
    topicsTitle: "인기 토픽",
    topicsViewAll: "모든 토픽 보기",
    topicsPageTitle: "연구 토픽",
    topicsPageDesc: "AI가 최신 논문을 요약한 연구 토픽을 탐색하세요",
    topicSearchCta: "LOHAS Papers에서 검색",
    topicRelated: "관련 토픽",
    footerTopics: "토픽",
  },
  "zh-Hans": {
    ...
    errorNetwork: "网络错误",
    serviceUnavailable: "AI搜索服务暂时不可用。请稍后再试。",
    errorGeneric: "发生错误",
    retry: "重试",
    cancel: "取消",
    done: "完成",
    ...
    maintenanceBanner: "AI搜索功能暂时停止服务。给您带来不便，深表歉意。",
    supervisedBadge: "医师监修",
    supervisedName: "上原 吉敬（医师）",
    supervisedAffiliation: "医师",
    footerSupervised: "医师监修: 上原 吉敬",
    trialBannerTitle: "想搜索更多论文吗？",
    trialBannerDesc: "创建免费账户，即可无限使用AI论文搜索和摘要功能。",
    trialBannerCta: "免费开始",
    trialSearchHint: "无需注册，免费试搜一次",
    topicsTitle: "热门主题",
    topicsViewAll: "查看所有主题",
    topicsPageTitle: "研究主题",
    topicsPageDesc: "探索AI从最新论文中总结的研究主题",
    topicSearchCta: "在LOHAS Papers搜索",
    topicRelated: "相关主题",
    footerTopics: "主题",
  },
  es: {
    ...
    maintenanceBanner: "La búsqueda con IA no está disponible temporalmente. Disculpe las molestias.",
    supervisedBadge: "Supervisado por médico",
    supervisedName: "Yoshiaki Uehara, M.D.",
    supervisedAffiliation: "Médico",
    footerSupervised: "Supervisado por Yoshiaki Uehara, M.D.",
    ...
    topicsViewAll: "Ver todos los temas",
    topicsPageTitle: "Temas de investigación",
    topicsPageDesc: "Explora temas de investigación resumidos por IA",
    topicSearchCta: "Buscar en LOHAS Papers",
    topicRelated: "Temas relacionados",
    footerTopics: "Temas",
  },
  "pt-BR": {
    appName: "LOHAS Papers",
    ...
    maintenanceBanner: "A busca com IA está temporariamente indisponível. Pedimos desculpas pelo inconveniente.",
    supervisedBadge: "Supervisionado por médico",
    supervisedName: "Yoshiaki Uehara, M.D.",
    supervisedAffiliation: "Médico",
    footerSupervised: "Supervisionado por Yoshiaki Uehara, M.D.",
    ...
    topicsTitle: "Temas populares",
    topicsViewAll: "Ver todos os temas",
    topicsPageTitle: "Temas de pesquisa",
    topicsPageDesc: "Explore temas de pesquisa resumidos por IA",
    topicSearchCta: "Pesquisar no LOHAS Papers",
    topicRelated: "Temas relacionados",
    footerTopics: "Temas",
  },
  th: {
    ...
    maintenanceBanner: "ฟังก์ชันค้นหา AI หยุดให้บริการชั่วคราว ขออภัยในความไม่สะดวก",
    supervisedBadge: "แพทย์กำกับดูแล",
    supervisedName: "Yoshiaki Uehara, M.D.",
    supervisedAffiliation: "แพทย์",
    footerSupervised: "กำกับดูแลโดย Yoshiaki Uehara, M.D.",
    trialBannerTitle: "ต้องการค้นหาบทความเพิ่มเติม?",
    trialBannerDesc: "สร้างบัญชีฟรีเพื่อค้นหาและสรุปบทความด้วย AI ได้ไม่จำกัด",
    trialBannerCta: "เริ่มใช้ฟรี",
    trialSearchHint: "ทดลองค้นหาฟรี 1 ครั้ง — ไม่ต้องสมัคร",
    topicsTitle: "หัวข้อยอดนิยม",
    topicsViewAll: "ดูหัวข้อทั้งหมด",
    topicsPageTitle: "หัวข้อวิจัย",
    topicsPageDesc: "สำรวจหัวข้อวิจัยที่สรุปโดย AI",
    topicSearchCta: "ค้นหาใน LOHAS Papers",
    topicRelated: "หัวข้อที่เกี่ยวข้อง",
    footerTopics: "หัวข้อ",
  },
  vi: {
    appName: "LOHAS Papers",
    ...
    maintenanceBanner: "Chức năng tìm kiếm AI tạm thời ngừng hoạt động. Xin lỗi vì sự bất tiện.",
    supervisedBadge: "Bác sĩ giám sát",
    supervisedName: "Yoshiaki Uehara, M.D.",
    supervisedAffiliation: "Bác sĩ",
    footerSupervised: "Giám sát bởi Yoshiaki Uehara, M.D.",
    ...
    topicsViewAll: "Xem tất cả chủ đề",
    topicsPageTitle: "Chủ đề nghiên cứu",
    topicsPageDesc: "Khám phá các chủ đề nghiên cứu được tóm tắt bởi AI",
    topicSearchCta: "Tìm kiếm trên LOHAS Papers",
    topicRelated: "Chủ đề liên quan",
    footerTopics: "Chủ đề",
  },
};
