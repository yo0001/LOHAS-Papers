...
const translations: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    topicsPageTitle: "医学研究トピック",
    topicsPageDesc: "AIが最新論文を要約した医学研究トピックを探索",
  ...
  en: {
    ...
    topicsPageTitle: "Medical Research Topics",
    topicsPageDesc: "Explore AI-summarized medical research topics from the latest papers",
  ...
  ko: {
    ...
    topicsPageTitle: "의학 연구 토픽",
    topicsPageDesc: "AI가 최신 논문을 요약한 의학 연구 토픽을 탐색하세요",
  ...
  "zh-Hans": {
    ...
    topicsPageTitle: "医学研究主题",
    topicsPageDesc: "探索AI从最新论文中总结的医学研究主题",
  ...
  es: {
    ...
    topicsPageTitle: "Temas de investigación médica",
    topicsPageDesc: "Explora temas de investigación médica resumidos por IA",
  ...
  "pt-BR": {
    ...
    topicsPageTitle: "Temas de pesquisa médica",
    topicsPageDesc: "Explore temas de pesquisa médica resumidos por IA",
  ...
  th: {
    ...
    topicsPageTitle: "หัวข้อวิจัยทางการแพทย์",
    topicsPageDesc: "สำรวจหัวข้อวิจัยทางการแพทย์ที่สรุปโดย AI",
  ...
  vi: {
    ...
    topicsPageTitle: "Chủ đề nghiên cứu y khoa",
    topicsPageDesc: "Khám phá các chủ đề nghiên cứu y khoa được tóm tắt bởi AI",
